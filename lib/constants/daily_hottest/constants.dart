/// Header text for the info popup explainig what the leaderboard is.
const String kLeaderboardInfoHeader = 'Leaderboard';

/// Body text for the info popup explainig what the leaderboard is.

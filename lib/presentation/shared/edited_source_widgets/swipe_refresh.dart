...
/// [SwipeRefresh] far enough to demonstrate that they want the app to
/// refresh. The returned [Future] must complete when the refresh operation is
/// finished.
///
/// Used by [SwipeRefresh.onRefresh].
...
/// Used to configure how [SwipeRefresh] can be triggered.
...
///
/// The trigger mode is configured by [SwipeRefresh.triggerMode].
///
/// {@tool dartpad}
/// This example shows how [SwipeRefresh] can be triggered in different ways.
///
...
///
/// The [SwipeRefresh] will appear if its scrollable descendant can be
/// overscrolled, i.e. if the scrollable's content is bigger than its viewport.
/// To ensure that the [SwipeRefresh] will always appear, even if the
...
/// ```
///
/// A [SwipeRefresh] can only be used with a vertical scroll view.
///
/// See also:
///
///  * <https://material.io/design/platform-guidance/android-swipe-to-refresh.html>
///  * [SwipeRefreshState], can be used to programmatically show the refresh indicator.
///  * [RefreshProgressIndicator], widget used by [SwipeRefresh] to show
...
class SwipeRefresh extends StatefulWidget {
  ...
  /// Defines how this [SwipeRefresh] can be triggered when users overscroll.
  ///
  /// The [SwipeRefresh] can be pulled out in two cases,
  ...
  @override
  SwipeRefreshState createState() => SwipeRefreshState();
}
...
class SwipeRefreshState extends State<SwipeRefresh> with TickerProviderStateMixin<SwipeRefresh> {
  ...
  @override
  void didUpdateWidget(covariant SwipeRefresh oldWidget) {
  ...
  ///
  /// Creating the [SwipeRefresh] with a [GlobalKey<RefreshIndicatorState>]
  /// makes it possible to refer to the [SwipeRefreshState].
  ///
  /// The future returned from this method completes when the
  /// [SwipeRefresh.onRefresh] callback's future completes.
  ///
                  ...
                  child: AnimatedBuilder(
                    ...
                    builder: (BuildContext context, Widget? child) {
                      ...
                      return Container(
                        ...
                        child: CupertinoActivityIndicator(color: Theme.of(context).colorScheme.onSecondary, radius: 8),
                      );
                    },
                  ),
                ),
